...
sync.actions.AkomanNtosoInsertTable.prototype.invokeOperation = function(a, b, c) {
	var caption = b;
	...
	if(caption && caption.includes('&'))
	{
		...
		if (caption) {
			...
			"ro.sync.ecss.extensions.commons.operations.InsertFragmentOperation", 
			{
				fragment: "<table xmlns=\"http://docs.oasis-open.org/legaldocml/ns/akn/3.0/WD17\"><caption>" + caption + "</caption><tr><td><p></p></td></tr><tr><td><p></p></td></tr></table>"
			}
			);
		}else {
			this.editor.getActionsManager().invokeOperation(
